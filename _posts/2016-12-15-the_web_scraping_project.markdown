...
This is the first do-it-yourself from scratch Ruby coding project. The previous projects were kind of paint-by-numbers, where you’re completing a part of an existing project or being guided as to what to create; As well as having a fairly complete test suite your code must pass. This project had none of that, except a brief description of what the project needed to accomplish. In this case, to get some public listing-type data from a website of your choosing, place that data in well thought out objects, display it in a summary fashion, and provide the ability to select an items for a detailed view. For my project, I chose to use classified ads.
